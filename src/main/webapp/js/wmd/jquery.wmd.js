...
WMDEditor.prototype = {
    getPanels: function() {
        return {
            ...
            saveTo: doc.getElementById(this.options.saveTo)
        };
    },
    ...
    var pushPreviewHtml = function(text){
        ...
        if (wmd.panels.output) {
			...
			// Send the HTML wrapped in <pre><code>
				...
				$(wmd.panels.output).html("<pre><code>" + newText + "</code></pre>");
			}
        }
        
		// put the rendered content in a textarea we are monitoring and saving
        if (wmd.panels.preview) {
            $(wmd.panels.preview).html(text);
			$(wmd.panels.saveTo).val(text);
        }
...
//
	...
	text = text.replace(/~T/g,"~");
		...
		// // RegExp.rightContext : illegal access
		// "abc".match("b");
